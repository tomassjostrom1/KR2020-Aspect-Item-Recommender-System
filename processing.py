...
def preprocessing_general(ratings, films, data_origin, aspects):
	start = time.time()
	...
	movies_all_aspects={}
	aspect_info = {}
	total_number_of_aspects = 0
    
	for aspect in aspects:	    
		aspects_in_db, movies_all_aspects_matrix = get_movies_aspect_matrix(films, aspect)
		movies_all_aspects[aspect] = movies_all_aspects_matrix
		aspect_info[aspect] = aspects_in_db
		total_number_of_aspects += len(aspects_in_db)
	...
	print('We have %d total aspects' % (total_number_of_aspects))
	...
	return films, ratings_dict, compressed_test_ratings_dict, sims, movies_all_genres_matrix, movies_all_directors_matrix, movies_all_actors_matrix,movies_all_aspects
...
def preprocessing(ratings, films, data_origin):
	...
	return films, ratings_dict, compressed_test_ratings_dict, sims, movies_all_genres_matrix, movies_all_directors_matrix, movies_all_actors_matrix,train_ratings_dict
